...
function urldo($urldo, $url){

$host2=parse_url($urldo, PHP_URL_HOST);
if(strlen($host2)<4){
$ext=substr($urldo, 0, 1);
if($ext=="#"){
...
if($ext=="."){
$ext2=substr($imgl, 1, 2);

if($ext2=="./"){
$image="http://".$url.$strn.$imgl;
}
