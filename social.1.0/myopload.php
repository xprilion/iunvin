...
$sqlx = "INSERT INTO streams(uid, name, username, text, time, type) VALUES ('$uid', '$name', '$uname', '$wext', '$time', '9')";
...
$sql = "DELETE FROM myopicto WHERE uid='$uid'";
if (!mysql_query($sql,$con))
  {
  die('Error: ' . mysql_error());
  }
...
$sql = "INSERT INTO myopicto(uid, pic, time, sid) VALUES ('$uid', '$piccy', '$time', '$mig')";
if (!mysql_query($sql,$con))
  {
  die('Error: ' . mysql_error());
  }
...
echo('<META HTTP-EQUIV="refresh" CONTENT="0; myopicto?file='.$piccy.'">');
